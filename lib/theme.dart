...
class LightModeColors {
  // Clean white/pink/purple palette based on second image
  static const lightPrimary = Color(0xFF9B59B6); // Purple
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFF8F1FF); // Very light purple
  static const lightOnPrimaryContainer = Color(0xFF4A148C);
  static const lightSecondary = Color(0xFFE91E63); // Pink accent
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFFBA68C8); // Light purple
  ...
  // Additional gradient colors for login screen
  static const gradientStart = Color(0xFFF3E5F5); // Very light purple
